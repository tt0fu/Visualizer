...
Shader "CustomUI"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            float3 RandomRainbow(float3 worldPos) {
                float chronoTime = _Time.y * _TimeScale + chrono * _ChronoScale;
                float p = noise(worldPos + float3(0, 0, (chronoTime * _WarpChronoTimeScale) % 1000));
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color.rgb *= RandomRainbow(IN.worldPosition.xyz / 100);
